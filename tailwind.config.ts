  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "title-xsm3": ["10px", "14px"],
        "title-xsm4": ["11.5px", "15.5px"],
      },
      spacing: {
        4.5: "1.125rem",
        5.5: "1.375rem",
      ...
      backgroundImage: {
        ...
        signup: "url('/images/auth/signup-bg.png')",
        landing: "url('/images/landing/backgroundimage_version1.svg')",
        login: "url('/images/landing/login.svg')",
      },
      backgroundPosition: {
